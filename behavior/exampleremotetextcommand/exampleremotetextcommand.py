...
'''"Simple example behavior that shows how to the remote text command module."'''

class ExampleRemoteTextcommand(basebehavior.abstractbehavior.AbstractBehavior):
    ...
    def get_name(self):
        return "ExampleRemoteTextcommand"
