...
'''For this behavior, no description has been entered in the behaviors_config file'''

class TestSubsumeHigher(basebehavior.abstractbehavior.AbstractBehavior):
