...
'''"This behavior will move the defender Nao around until the ball is seen in the middle of the FoV."'''

class FindBallDefender(basebehavior.abstractbehavior.AbstractBehavior):
