    ...
    def __init__(self, cameranumber=-1, source='camera', resolution='verylow', filename=None):
        ...
        if self.source == 'camera':
            ...
            # else use default settings
                ...
                cv.SetCaptureProperty(self.CAM, cv.CV_CAP_PROP_FRAME_WIDTH, 320)
                cv.SetCaptureProperty(self.CAM, cv.CV_CAP_PROP_FRAME_HEIGHT, 240)
                ...
                cv.SetCaptureProperty(self.CAM, cv.CV_CAP_PROP_FRAME_HEIGHT, 720)
...
#        cv.WaitKey(5)
    ...
    cameranumber = 0
    takeImages = TakeImages(cameranumber, 'camera', 'high')
